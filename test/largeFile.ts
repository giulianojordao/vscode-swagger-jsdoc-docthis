...
interface SomeInterface {
    ...
    /**
     * Testing with swaggerjsdocdocthis.includeMemberOfOnInterfaceMembers set to false.
     */
...
class SomeClass {
    ...
    /**
     * Testing with swaggerjsdocdocthis.includeMemberOfOnClassMembers set to false
     *
     * @param {string} someParam1
     * @param {number} someParam2
     * @returns {boolean}
